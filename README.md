...
https://www.youtube.com/embed/Z0CeE3449qw

== Installation ==

1.  **Download** the plugin ZIP file.
2.  **Upload** the entire `ric-ultimate-cookie-consent` folder to the `/wp-content/plugins/` directory via FTP.
    OR
    Go to **WordPress Dashboard** > **Plugins** > **Add New** > **Upload Plugin**, then choose the downloaded ZIP file and click "Install Now".
3.  **Activate** the plugin through the 'Plugins' menu in WordPress.
4.  Go to **Settings** > **Cookie Consent** to configure your banner.

== Frequently Asked Questions ==

= How do I change the cookie consent message? =
Navigate to **Settings > Cookie Consent** in your WordPress dashboard. You will find a text area labeled "Cookie Consent Text" where you can customize the message. Basic HTML tags like `<strong>`, `<em>`, and `<a>` are supported.
...
= How do I change the position of the banner? =
...
(No screenshots yet. You will need to add these to your WordPress.org plugin page)
